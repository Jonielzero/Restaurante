    ...
    public partial class registro_ventas : Form
    {
        ...
        private void btnbusmes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    busqueda = "fechaventa >= DATEADD(DAY, DATEDIFF(DAY, 0, GETDATE()), 0)  AND fechaventa <= GETDATE() ";
                }
        ...
        private void txtano_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                // Bloquea el dígito solo si ya hay 4 caracteres
                e.Handled = txtano.Text.Length >= 4;
            }
            else if (char.IsControl(e.KeyChar))
            {
                e.Handled = false; // Backspace, Delete, etc. siempre permitidos
            }
            ...
            {
                e.Handled = true; // cualquier otro carácter no permitido
            }
        }
